...
\item Hovering over an attention span circle invoked a steel blue overlay showing the number of seconds that was spent on the article
\\
\noindent\includegraphics[scale=0.8]{img/country_circle_hover} \\   
\end{itemize} 
...
\item As for adjusting the stacked area graph's time range, there was approximately a 3-second delay for the ~10,000 hits and a approximately a 10-second delay for the ~40,000 hits. This was done using a PC with an Intel i7 processor and 12 GB of RAM. 
